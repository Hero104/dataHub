(function() {
    ...
    angular.module('BlurAdmin.pages.countActivity').controller('postInfoCtrl', postInfoCtrl);

    /** @ngInject */
    function postInfoCtrl($scope, ipCookie, utilService, activityUrl) {
        ...
        utilService.dataInfo(activityUrl.testUrl, token).then(function(res) {
            var postList = [];
            for(var i = 0; i < 36; i++) {
                postList.push({
                    id: i + 1,
